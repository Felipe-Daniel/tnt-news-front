...
const fakeAPI = [
  {
    ...
    title:
      "O Futuro das Redes Neurais: Avanços Promissores na Inteligência Artificial",
    category: "Tecnologia",
...
function Main() {
  const [currentSection, setCurrentSection] =
    useState<string>("Últimas notícias");
  ...
  return (
    <div className="bg-zinc-900 h-screen flex flex-col">
      ...
      <div className="flex h-full">
        ...
        {!currentSection.endsWith("notícias") && (
          <NewsByCategory news={fakeAPI} category={currentSection} />
        )}
      </div>
    </div>
  );
